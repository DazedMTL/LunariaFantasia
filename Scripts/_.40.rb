module Person
  ...
  Name = { 0 => ["", 0,""], #For key person characters↓
           1 => ["Mariana", 24,"Mariana"], # Court Magician・Researcher
           2 => ["Diana", 27, "Diana"], # Queen of the Magical Kingdom
           3 => ["Millay", 17, "Millay"], # Head of the Court Magicians
           4 => ["Shirley", 21, "Shirley"], # Court Magician・Classmate from Academy
           5 => ["Estia", 21, "Estia"], # Court Magician・Classmate from Academy
           6 => ["Eleanor", 21, "Eleanor"], # Mother of Lunaria
           7 => ["Meris", 21, "Meris"], # Traveling Loli Busty Sister
           8 => ["Drake", 21, ""], # Leader of the Sagittarius Knights・General
           9 => ["Salvia", 21, "Salvia"], # Instructor of Summoning at the Magical Academy
           10 => ["", 21, ""],
           11 => ["Lili", 21, "Lili"], #Court Magician・Senior
           12 => ["Tsukiha", 25, "Tsukiha"], # Village Chief of Tokiwa
           13 => ["Filica", 25, "Filica"], # Queen of Dalia
           14 => ["Sigun", 21, "Sigun"], # First King of Sagittarius
           15 => ["Sia", 21, ""], # First Queen Consort of Sagittarius・Childhood Friend
           16 => ["Mashiro", 21, ""], # Legendary Shrine Maiden of Tokiwa
           21 => ["Wright", 23, "Wright"], # Husband of Sonia
           22 => ["Gord", 23, ""], # Wealthy Magnate of Dalia
           23 => ["Delta", 23, "Delta"], # Minister of Dalia・Delta Aberaze
           25 => ["Hime", 21, ""], # Maid Sister of Dalia's Wealthy Magnate・Younger Sister
           26 => ["Nami", 21, ""], # Maid Sister of Dalia's Wealthy Magnate・Elder Sister
           31 => ["Renno", 31, "Renno"],
           32 => ["Asmolios", 31, "Asmolios"],
           41 => ["Zepar", 31, "Zepar"],
           42 => ["Magatsuorochi", 31, "Magatsuorochi"],
           43 => ["Soul of Zepar", 31, ""],
           44 => ["Tamamo-no-Mae", 31, "Tamamo"],
           51 => ["Beelzelian", 31, "Beelzelian"],
           61 => ["Rasphlea", 21, ""], # Goddess of Creation from the World Genesis Mythology
           62 => ["Margleina", 21, ""], # Goddess of Destruction from the World Genesis Mythology
          }

  Sub =  { 0 => ["", 0, ""],  #For named subcharacters↓
           1 => ["Porco", 23, ""], # Youth of Robe
           2 => ["Kamala", 23, ""], # High Priest of Zepar Sect
           3 => ["Shuuto", 21, ""], # Shota of Biossa
           4 => ["Capella", 21, ""], #↑ Mother of Shota from Biossa
           5 => ["Kanzou", 23, ""], # Innkeeper from Dalia region
           6 => ["Arx", 8, ""], # Dark Magician from same period in the academy
           7 => ["Toukichi", 8, ""], # Sakai's Village Head
           8 => ["Gokou", 8, ""],# Son of Sakai's Village Head
           9 => ["", 21, ""],
           10 => ["", 21, ""],
           11 => ["Sara", 21, ""], # Mage stationed in Robe
           12 => ["", 21, ""],
           13 => ["", 21, ""],
           14 => ["Haruna", 21, "Haruna"], # Close Acolyte of Tsukiha
           15 => ["", 21, ""],
           16 => ["Rosa", 21, "Rosa"], # Maid serving Filica
           17 => ["Eris", 21, "Eris"], # Captain of the Peony Knights・Eliora's sister
           18 => ["Felicia", 21, "Felicia"], # Vice-Captain of the Peony Knights・Loves risqué things
           19 => ["Ellusia", 21, "Ellusia"],# Eliora's mother
           20 => ["Elli", 21, ""], # Nickname for Ellusia
           21 => ["Bake", 8, ""], # Thief of Nemesia
           22 => ["Goblin", 8, ""],
           23 => ["Yamako A", 8, ""],
           24 => ["Yamako B", 8, ""],
           25 => ["Evil Dragon", 21, ""],
           ...
           29 => ["", 21, ""],
           30 => ["", 21, ""],
           31 => ["Velvet", 21, "Velvet"], # Female Minister of Sagittarius Velvet Ward
           32 => ["Eriora", 21, "Eriora"], # Ice Lady・Self-proclaimed rival of Lunaria
           33 => ["Vieria", 21, "Vieria"], # Brothel Owner
           34 => ["Anemone", 21, ""], # Snow Lady
           35 => ["Ranun", 21, "Ranun"], # Snow Queen
           36 => ["Geor", 21, ""], # Corrupt Merchant of Dalia
           37 => ["Karl", 21, ""], # Soldier in front of abandoned mine
           38 => ["Maki", 21, "Maki"], # Snow Lady・Friend of Anemone
           39 => ["Bunny Witch", 21, ""], # Bunny Witch
           40 => ["Rugool", 21, ""], # Father of Eliora・Leader of Dalia Kingdom's Knights Order General Rank
           41 => ["Sakura", 21, "Sakura"], #
           42 => ["Yuri", 21, "Yuri"],
           43 => ["Kohana", 21, "Kohana"],
           44 => ["Hakuto", 21, ""], # Son of Tsukiha・Name only
           45 => ["", 21, ""],
           46 => ["", 21, ""],
           47 => ["", 21, ""],
           48 => ["", 21, ""],
