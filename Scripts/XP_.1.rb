...
module LNX11
  ...
  MESSAGE_TYPE  =  1   # 規定値:2
    ...
    MESSAGE_WAIT = {:battle_start => [60, false], :victory   => [ 60, false], 
  ...
  # 戦闘開始時の敵出現メッセージを表示する
  MESSAGE_WINDOW_ENEMY_NAMES = true # 規定値:false
  ...
  "HOL",                 # "MDEF"    / 魔法防御  Magic DEFense power
  "AGI",                 # "AGI"     / 敏捷性    AGIlity
  "MNT",                 # "LUCK"    / 運        LUCK
  ]
  ...
  LAST_TARGET           = false   # 規定値:true

  # パーティコマンドのカーソル位置を記憶する    true = 有効 / false = 無効
  LAST_PARTY_COMMAND    = false   # 規定値:true 
