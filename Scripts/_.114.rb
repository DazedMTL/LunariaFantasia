...
module Quest
  ...
  #--------Only after clearing the ruins No.6-----------------------------------------------------------------------------------
             ...
             [6,   56,         "Major Suppression",   "Sagittarius Town Adventurer's Guild", "Guild Receptionist \emob[qp2]", "2000\eg", "11～", 
             "\e}Defeat the Giant Slime!", #7-Title
             #8-Details
